...
import { isLogin } from "@/lib/clientUser";

export const Footer = () => {
    const loginMsg = isLogin();
    ...
    return <footer className="fixed bottom-0 left-0 right-0 max-w-sm mx-auto /80 backdrop-blur-sm border-t border-gray-100 rounded-t-3xl" >
        <div className="flex justify-around items-center h-16">
            <a href="#" className="text-pink-500 flex flex-col items-center gap-1" onClick={() => router.push('/')}>
            ...
            <a href="#" className="text-gray-400 flex flex-col items-center gap-1" onClick={() => router.push(loginMsg?.isLogined ? '/auth/signout' : '/auth/signin')}>
                <User size={24} />
            </a>
        </div>
    </footer >
